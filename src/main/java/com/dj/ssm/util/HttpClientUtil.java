...
public class HttpClientUtil {
	 ...
	 * @throws Exception
	 */
	public static String sendHttpRequestFile(String url, Map<String, String> params, InputStream inputStream) throws Exception {
		CloseableHttpClient httpClient = null;
		CloseableHttpResponse response = null;
		String result = null;
		try{
			...
			// 流文件
			multipartEntityBuilder.addBinaryBody("uploadFile", inputStream, ContentType.create("multipart/form-data"), "text01.txt");
			// httpEntity
			HttpEntity httpEntity = multipartEntityBuilder.build();
			httpPost.setEntity(httpEntity);
			// 执行
	 ...
	 * @throws Exception
	 */
	public static String sendHttpRequestJson(String url, String jsonParam) throws Exception {
		CloseableHttpResponse response = null;
		CloseableHttpClient httpClient = null;
		String result = null;
		try{
